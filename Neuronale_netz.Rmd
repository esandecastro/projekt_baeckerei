...
norm_list <- c("Umsatz", "Temperatur", "Windgeschwindigkeit", "Bewoelkung", "Wettercode")
...
features = c('Temperatur_norm', "Windgeschwindigkeit_norm", "Bewoelkung_norm", "Wettercode_norm", ferien_dummies, ferienCAU_dummies)
