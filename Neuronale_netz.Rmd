...
norm_list <- c("Umsatz", "Temperatur", "Windgeschwindigkeit")
#, "Umsatz_letze_1__Tage", "Umsatz_letze_3__Tage", "Umsatz_letze_7__Tage", "Umsatz_letze_30__Tage"
...
#"Umsatz_letze_1__Tage_norm", "Umsatz_letze_3__Tage_norm", "Umsatz_letze_7__Tage_norm", "Umsatz_letze_30__Tage_norm"
features = c('Temperatur_norm', "Windgeschwindigkeit_norm", ferien_dummies, ferienCAU_dummies)
...
```{python}
model = keras.models.load_model("neuronal_model.h5")
```
