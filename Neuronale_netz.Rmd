...
norm_list <- c("Umsatz", "Warengruppe", "Bewoelkung", "Temperatur", "Windgeschwindigkeit", "Wettercode", "Umsatz_letze_1__Tage", "Umsatz_letze_2__Tage", "Umsatz_letze_3__Tage", "Umsatz_letze_7__Tage", "Umsatz_letze_30__Tage", "Wochentag")
...
features = c('Warengruppe_norm', 'Bewoelkung_norm', 'Temperatur_norm', 'Windgeschwindigkeit_norm', 'Wettercode_norm', 'Umsatz_letze_1__Tage_norm', 'Umsatz_letze_2__Tage_norm', 'Umsatz_letze_3__Tage_norm', 'Umsatz_letze_7__Tage_norm', 'Umsatz_letze_30__Tage_norm', 'Wochentag_norm', ferien_dummies, ferienCAU_dummies)
...
train_ind <- sample(seq_len(nrow(Umsatz_norm)), size = floor(0.80 * nrow(Umsatz_norm)))
# Teilen in Trainings- und Testdatensatz
train_dataset = Umsatz_norm[train_ind, features]
test_dataset = Umsatz_norm[-train_ind, features]
# Selektion der Variable, die als Label definiert wurde
train_labels = Umsatz_norm[train_ind, label]
test_labels = Umsatz_norm[-train_ind, label]
```
